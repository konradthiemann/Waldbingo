...
(function () {
  ...
  function svg(inner, cls) {
    return '<svg class="' + (cls || '') + '" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">' + inner + '</svg>';
  }

  window.WB_ICON = function (id, cls) { return I[id] ? svg(I[id], cls || 'pico') : ''; };
  window.WB_HAS_ICON = function (id) { return !!I[id]; };
  window.WB_UI = function (name, cls) { return U[name] ? svg(U[name], cls || 'ui-ic') : ''; };
  window.WB_ICON_IDS = Object.keys(I);
})();
